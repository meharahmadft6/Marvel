...
<body class="bg-black text-white">
    ...
    <div class="container mx-auto px-4 mt-10">
        <div class="text-center pt-16">
            ...
            <p class="text-gray-400 mt-4">Update and edit your blog post with ease.</p>
        </div>
            ...
            <form action="{{ route('blog.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="min_to_read" placeholder="Enter minutes to read..."
                        class="w-full p-3 rounded-lg bg-gray-700 text-white focus:ring-2 focus:ring-red-500 focus:outline-none"
                        value="{{ old('min_to_read', $post->min_to_read) }}">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="body" placeholder="Write your content here..."
                        class="w-full p-3 rounded-lg bg-gray-700 text-white h-40 focus:ring-2 focus:ring-red-500 focus:outline-none">{{ old('body', $post->body) }}</textarea>
                </div>

                <!-- File Upload -->
                <div class="mb-6">
                    <label class="block text-lg font-semibold mb-2">Upload Image (Optional)</label>
                    ...
                    @if ($post->image_url)
                    <p class="text-gray-300 mt-2">Current Image: <img src="{{ asset($post->image_url) }}" alt="Current Post Image" class="w-24 h-24 object-cover rounded mt-2"></p>
                    @endif
                </div>
